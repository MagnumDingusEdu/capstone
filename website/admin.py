...
class ScholarshipAdmin(ScholarshipSummernoteAdmin, admin.ModelAdmin):
    ...
    search_fields = ('name', 'constraints__name', 'eligibility_criteria', 'value_of_scholarship')
...
class ReceivedScholarshipAdmin(admin.ModelAdmin):
    ...
    search_fields = (
        'student__roll_no', 'student__user__first_name', 'student__user__last_name', 'student__user__email',
        'scholarship__name')
